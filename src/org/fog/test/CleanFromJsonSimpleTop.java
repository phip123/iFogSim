 ...
 */
public class CleanFromJsonSimpleTop {
    ...
    public static void main(String[] args) {
        ...
        try {
             ...
             */
            PhysicalTopology physicalTopology = JsonToTopology.getPhysicalTopology(broker.getId(), appId, "topologies/simple_top");
    ...
    private static Application createApplication(String appId, int userId) {
        ...
        application.addTupleMapping(mxnetService, imageTuple, resultTuple, new FractionalSelectivity(1.0));

        application.addAppEdge(client, mxnetService, 800, 20, 10, imageTuple, Tuple.UP, AppEdge.MODULE); // adding periodic edge (period=800ms) from Client to MXNet service module carrying tuples of type IMAGE
        application.addAppEdge(mxnetService, client, 14, 20, resultTuple, Tuple.DOWN, AppEdge.MODULE);  // adding edge from Concentration Calculator to Client module carrying tuples of type CONCENTRATION
